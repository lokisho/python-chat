...
def send_message(event, context):
    ...
    table_messages = dynamodb.Table("serverless-chat_Messages")
    ...
    response = table_messages.query(KeyConditionExpression="Room = :room",
    ...
    table_messages.put_item(Item={"Room": "general", "Index": index,
